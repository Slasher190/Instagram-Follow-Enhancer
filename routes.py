...
# @router.get("/test", response_description="Insta Test")
# async def test(request: Request, response: Response):
#     try:    
#         Instagram = await DriverInitialization('https://www.instagram.com/', 'iplug_bhopal', 'iplugmp0987')
#         await Instagram.diver_initialization()
#         response.status_code = status.HTTP_200
#     except Exception as e:
#         raise HTTPException(status_code=status.HTTP_400, detail=f"Can't start")
